...
var ModelItems = [
  {
    ...
    lighting_mode: 'IBL',
    resources: [
      require('../res/object_dragon_anim/object_dragon_pbr_Base_Color.png'),
      require('../res/object_dragon_anim/object_dragon_pbr_Metallic.png'),
      require('../res/object_dragon_anim/object_dragon_pbr_Mixed_AO.png'),
      require('../res/object_dragon_anim/object_dragon_pbr_Normal_OpenGL.png'),
      require('../res/object_dragon_anim/object_dragon_pbr_Roughness.png'),
    ],
  },
  {
    name: 'icecream_man',
    ...
    resources: [
      ...
      require('../res/icecreamman_anim/icecream_man_pbr_Mixed_AO.png'),
  ...
  },
  {
    ...
    lighting_mode: 'IBL',
    resources: [
      require('../res/object_pug_animated/pug_body_diffuse.png'),
      require('../res/object_pug_animated/pug_body_normal.png'),
      require('../res/object_pug_animated/pug_body_specular.png'),
    ],
  },
  {
    name: 'emoji_smile',
    ...
    ref_pointer: undefined,
    resources: [
      require('../res/emoji_smile_anim_a/emoji_smile_diffuse.png'),
      require('../res/emoji_smile_anim_a/emoji_smile_normal.png'),
      require('../res/emoji_smile_anim_a/emoji_smile_specular.png'),
    ],
  },
  {
    name: 'emoji_sad',
    ...
    ref_pointer: undefined,
    resources: [
      require('../res/emoji_sad_anim/emoji_sad_diffuse.png'),
      require('../res/emoji_sad_anim/emoji_sad_normal.png'),
      require('../res/emoji_sad_anim/emoji_sad_specular.png'),
    ],
  },
  {
    name: 'emoji_wow',
    ...
    ref_pointer: undefined,
    resources: [
      require('../res/emoji_wow_anim/emoji_wow_diffuse.png'),
      require('../res/emoji_wow_anim/emoji_wow_normal.png'),
      require('../res/emoji_wow_anim/emoji_wow_specular.png'),
    ],
  },
  {
    name: 'emoji_angry',
    ...
    ref_pointer: undefined,
    resources: [
      require('../res/emoji_angry_anim/emoji_angry_diffuse.png'),
  ...
  },
  {
    ...
    ref_pointer: undefined,
    resources: [
      require('../res/emoji_kiss_anim/emoji_kiss_diffuse.png'),
  ...
  },
  {
    ...
    ref_pointer: undefined,
    resources: [
      require('../res/emoji_thumbsup_anim/emoji_thumbsup_diffuse.png'),
      require('../res/emoji_thumbsup_anim/emoji_thumbsup_specular.png'),
    ],
  },
  {
    name: 'emoji_poop',
    ...
    ref_pointer: undefined,
    resources: [
      require('../res/emoji_poop_anim/emoji_poop_diffuse.png'),
      require('../res/emoji_poop_anim/emoji_poop_normal.png'),
      require('../res/emoji_poop_anim/emoji_poop_specular.png'),
    ],
  },
  {
    name: 'object_star',
    ...
    resources: [
      require('../res/object_star_anim/blinn1_Base_Color.png'),
      require('../res/object_star_anim/blinn1_Metallic.png'),
      require('../res/object_star_anim/blinn1_Roughness.png'),
    ],
  },
  {
    name: 'object_rainbow',
    ...
    resources: [
      require('../res/object_rainbow_anim/object_rainbow_Base_Color.png'),
      require('../res/object_rainbow_anim/object_rainbow_Metallic.png'),
      require('../res/object_rainbow_anim/object_rainbow_Roughness.png'),
    ],
  },
  {
    name: 'object_cloud',
    ...
    spotlight_position_y: 9.2,
    resources: [
      require('../res/object_cloud_anim/object_cloud_anim_object_cloud_BaseColor.png'),
      require('../res/object_cloud_anim/object_cloud_anim_object_cloud_Metallic.png'),
      require('../res/object_cloud_anim/object_cloud_anim_object_cloud_Roughness.png'),
    ],
  },
  {
  ...
  },
  {
    ...
    lighting_mode: 'IBL',
    resources: [
      require('../res/object_flowers_anim/blinn1_Roughness.png'),
      require('../res/object_flowers_anim/blinn1_Metallic.png'),
      require('../res/object_flowers_anim/blinn1_Base_Color.png'),
      require('../res/object_flowers_anim/blinn1_Normal_OpenGL.png'),
    ],
  },
];
module.exports = {
