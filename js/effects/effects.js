...
export function getFireWorks() {
  ...
  f[11] = getFireWorkGravity(
    polarToCartesian([radius, -85, 20]),
    colors[7],
    3000,
  );
  f[12] = getFireWorkGravity(
    polarToCartesian([radius, -60, 42]),
    colors[0],
    4800,
  );
  f[13] = getFireWorkGravity(
    polarToCartesian([radius, -40, 10]),
    colors[3],
    2600,
  );
  f[14] = getFireWorkGravity(
    polarToCartesian([radius, -10, 15]),
    colors[5],
    1500,
  );
  f[16] = getFireWorkGravity(
    polarToCartesian([radius, -5, 20]),
    colors[3],
    300,
  );
  f[15] = getFireWorkGravity(
    polarToCartesian([radius, 5, 20]),
    colors[6],
    3000,
  );
  f[29] = getFireWorkGravity(
    polarToCartesian([radius, 12, 15]),
    colors[6],
    1300,
  );
  f[17] = getFireWorkGravity(
    polarToCartesian([radius, 30, 40]),
    colors[3],
    2200,
  );
  f[18] = getFireWorkGravity(
    polarToCartesian([radius, 45, 25]),
    colors[3],
    1500,
  );
  f[19] = getFireWorkGravity(
    polarToCartesian([radius, 85, 36]),
    colors[3],
    3500,
  );

  f[20] = getFireWorkBrightDarkBright(
    polarToCartesian([radius, -80, 30]),
    colors[0],
    colors[3],
    2340,
  );
  f[21] = getFireWorkBrightDarkBright(
    polarToCartesian([radius, -50, 40]),
    colors[1],
    colors[4],
    0,
  );
  f[22] = getFireWorkBrightDarkBright(
    polarToCartesian([radius, -25, 20]),
    colors[2],
    colors[5],
    800,
  );
  f[23] = getFireWorkBrightDarkBright(
    polarToCartesian([radius, -15, 33]),
    colors[3],
    colors[7],
    2000,
  );
  f[24] = getFireWorkBrightDarkBright(
    polarToCartesian([radius, 8, 40]),
    colors[4],
    colors[6],
    1200,
  );
  f[25] = getFireWorkBrightDarkBright(
    polarToCartesian([radius, 10, 20]),
    colors[4],
    colors[6],
    1800,
  );
  f[26] = getFireWorkBrightDarkBright(
    polarToCartesian([radius, 35, 33]),
    colors[4],
    colors[6],
    200,
  );
  f[27] = getFireWorkBrightDarkBright(
    polarToCartesian([radius, 65, 40]),
    colors[4],
    colors[6],
    3720,
  );
  f[28] = getFireWorkBrightDarkBright(
    polarToCartesian([radius, 90, 25]),
    colors[4],
    colors[6],
    1020,
  );
    ...
    <ViroParticleEmitter
      ...
      particleAppearance={{
        ...
        color: {
          ...
          factor: 'Time',
          interpolation: [{endValue: color, interval: [600, 1500]}],
        },
      }}
      particlePhysics={{
        explosiveImpulse: {
    ...
    <ViroParticleEmitter
      ...
      particleAppearance={{
        opacity: {
          initialRange: [1.0, 1.0],
          factor: 'Time',
          interpolation: [{endValue: 0.0, interval: [0, 600]}],
        },
