...
var PortalItemRender = createReactClass({
  ...
  render: function () {
    var portalItem =
      PortalData.getPortalArray()[this.props.portalIDProps.index];
        ...
        <ViroPortalScene
          ...
          <ViroPortal>
            ...
            <Viro3DObject
              ...
              onLoadStart={this._onObjectLoadStart(
                this.props.portalIDProps.uuid,
              )}
